...
int MesureMaxi = 300; // Distance maxi a mesurer en cm//
int MesureMini = 3; // Distance mini a mesurer en cm//
...
void loop() 
{
// Debut de la mesure avec un signal de 10 μS appliquesur TRIG //
...
Distance = Duree*0.034/2; // distance = aller + retour, vitesse du son 340 m/s = 0.034 cm/µs //
